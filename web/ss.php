...
$sql="select g.id, g.title, g.publisher, g.year, g.genre, g.reltype, i.filename, r.name from games g left join images i on g.id = i.gameid left join genres r on g.genre = r.id order by filename";
